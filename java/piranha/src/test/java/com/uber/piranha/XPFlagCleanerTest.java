...
public class XPFlagCleanerTest {
  ...
  @Test
  public void testSpacingForSingleElseIfTreated() throws IOException {
    ErrorProneFlags.Builder b = ErrorProneFlags.builder();
    b.putFlag("Piranha:FlagName", "STALE_FLAG");
    b.putFlag("Piranha:IsTreated", "true");
    b.putFlag("Piranha:Config", "config/properties.json");
    ...
    bcr.addInputLines(
        ...
        .addOutputLines(
            ...
            "}")
        .addInputLines(
            "XPFlagCleanerElseIfSpacing.java",
            "package com.uber.piranha;",
            "class XPFlagCleanerElseIfSpacing {",
            " private XPTest experimentation;",
            " public void foo (boolean x) {",
            "  if (x) { System.out.println(\"if block\"); }",
            "  else if (experimentation.isToggleEnabled(TestExperimentName.STALE_FLAG)) { System.out.println(\"else if block\"); }",
        ...
        .addOutputLines(
            ...
            " public void foo (boolean x) {",
            "  if (x) { System.out.println(\"if block\"); }",
            "  else { System.out.println(\"else if block\"); }",
            " }",
            "}");
  ...
  @Test
  public void testSpacingForMultipleElseIfTreated() throws IOException {
    ErrorProneFlags.Builder b = ErrorProneFlags.builder();
    b.putFlag("Piranha:FlagName", "STALE_FLAG");
    b.putFlag("Piranha:IsTreated", "true");
    b.putFlag("Piranha:Config", "config/properties.json");
    ...
    bcr.addInputLines(
        ...
        .addInputLines(
            ...
            "  if (x) { System.out.println(\"if block\"); }",
            "  else if (y) { System.out.println(\"else if block\"); }",
            "  else if (experimentation.isToggleEnabled(TestExperimentName.STALE_FLAG)) { System.out.println(\"else if else if block\"); }",
            "  else { System.out.println(\"else block\"); }",
            " }",
            "}")
        .addOutputLines(
            ...
            "  if (x) { System.out.println(\"if block\"); }",
            "  else if (y) { System.out.println(\"else if block\"); }",
            "  else { System.out.println(\"else if else if block\"); }",
            " }",
            "}");
  ...
  @Test
  public void testSpacingForSingleElseIfControl() throws IOException {
    ErrorProneFlags.Builder b = ErrorProneFlags.builder();
    b.putFlag("Piranha:FlagName", "STALE_FLAG");
    b.putFlag("Piranha:IsTreated", "false");
    b.putFlag("Piranha:Config", "config/properties.json");
  ...
  @Test
  public void testSpacingForMultipleElseIfControl() throws IOException {
    ErrorProneFlags.Builder b = ErrorProneFlags.builder();
    b.putFlag("Piranha:FlagName", "STALE_FLAG");
    b.putFlag("Piranha:IsTreated", "false");
    b.putFlag("Piranha:Config", "config/properties.json");
