...
def run_java_ff_demo():
    ...
    output_summary_java = run_piranha_cli(join(feature_flag_dir, "java"), join(feature_flag_dir, "java/configurations"), False)
...
def run_kt_ff_demo():
    ...
    output_summary_kt = run_piranha_cli(join(feature_flag_dir, "kt"), join(feature_flag_dir, 'kt/configurations'), False)
