...
from experimental.rule_inference.piranha_chat import (PiranhaChatException,
                                                      PiranhaGPTChat)
from experimental.rule_inference.rule_application import \
...
class PiranhaAgent:
    ...
    def infer_rules(self) -> Tuple[bool, str]:
        ...
        :return: A tuple indicating whether the rule was successfully inferred and the rule itself or error message
    ...
    def iterate_inference(
        self, chat_interactions: List[PiranhaGPTChat]
    ) -> Tuple[bool, str]:
        """
    ...
    def improve_rule(self, task: str, rules: str) -> Tuple[bool, str]:
        ...
        :type rules: str
        :return: A tuple indicating whether the rule was improved successfully and the improved rule itself or error message
        :rtype: Tuple[bool, str]
        """
        max_rounds = 15
