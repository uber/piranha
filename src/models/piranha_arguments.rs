...
use super::{
  default_configs::{
    ...
    default_rule_graph, default_substitutions, CSHARP, GO, JAVA, KOTLIN, PYTHON, RUBY, SWIFT, TSX,
    TYPESCRIPT,
  },
...
pub struct PiranhaArguments {
  ...
  #[clap(short = 'l', value_parser = clap::builder::PossibleValuesParser::new([JAVA, SWIFT, PYTHON, KOTLIN, GO, TSX, TYPESCRIPT, RUBY, CSHARP])
