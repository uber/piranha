...
impl PartialEq for ConstraintKind {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            (ConstraintKind::Matches { capture: c1, regex: r1 }, 
             ConstraintKind::Matches { capture: c2, regex: r2 }) => {
                c1 == c2 && r1.as_str() == r2.as_str()
            }
            (ConstraintKind::Length { capture: c1, op: o1, value: v1 }, 
             ConstraintKind::Length { capture: c2, op: o2, value: v2 }) => {
                c1 == c2 && o1 == o2 && v1 == v2
            }
            (ConstraintKind::Comparison { capture: c1, op: o1, value: v1 }, 
             ConstraintKind::Comparison { capture: c2, op: o2, value: v2 }) => {
                c1 == c2 && o1 == o2 && v1 == v2
            }
            _ => false,
        }
...
impl ConcreteSyntax {
    ...
    fn parse_alternation(pair: Pair<Rule>) -> Result<CsPattern, String> {
        let sequences: Result<Vec<_>, _> = pair.into_inner()
    ...
    fn parse_sequence(pair: Pair<Rule>) -> Result<CsPattern, String> {
        let elements: Result<Vec<_>, _> = pair.into_inner()
    ...
    fn parse_where_clause(pair: Pair<Rule>) -> Result<Vec<CsConstraint>, String> {
        let constraints: Result<Vec<_>, _> = pair.into_inner()
