...
describe('comments', () => {
    describe('#collateCommentsByPosition', () => {
        it("should collate given comments", () => {
            ...
            assert(leadingComments.length == 1 && leadingComments[0].value == 'a' && trailingComments.length == 1 && trailingComments[0].value == 'c' && remainingComments.length == 1 && remainingComments[0].value == 'b');
        });
        ...
        it("should collate given comments", () => {
            ...
            let leadingComments, trailingComments, remainingComments;
            [leadingComments, trailingComments, remainingComments] = engine.collateCommentsByPosition(ast.body[0]);
            assert(leadingComments.length == 1 && leadingComments[0].value == 'a' && trailingComments.length == 2 && trailingComments[0].value == 'b' && trailingComments[1].value == 'c' && remainingComments.length == 0);
        });
    });
    ...
    describe('#attachCommentsAtEnd', () => {
        it("should attach comments at the end of previously present comments", () => {
            ...
            assert(comm.length == 4 && comm[0].value == 'a' && comm[1].value == 'b' && comm[2].value == 'c' && comm[3].value == 'd');
        });
    });
    ...
    describe('#attachCommentsAtBeginning', () => {
        it("should attach comments in front of previously present comments", () => {
            ...
            let comm = ast.body[0].comments;
            assert(comm.length == 4 && comm[0].value == 'c' && comm[1].value == 'd' && comm[2].value == 'a' && comm[3].value == 'b');
        });
    });
