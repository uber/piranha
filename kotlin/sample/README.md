NOTE: This project is currently configured to build as part of the larger `piranha/kotlin` build. If you wish to build this sample as a standalone gradle project, you need to:
