...
def thrift_demo():
    ...
    error_code_mapping = {"Invalid": "INVALID_ARGUMENT",
                          ...
                          "BadArgument": "INVALID_ARGUMENT",
                          "Client": "INVALID_ARGUMENT",
                          "Validation": "INVALID_ARGUMENT",
                          "Requester": "INVALID_ARGUMENT",
                          "TooLarge": "INVALID_ARGUMENT",
                          "Precondition": "FAILED_PRECONDITION",
                          "Condition": "FAILED_PRECONDITION",
                          "Range": "OUT_OF_RANGE",
                          "Unauthenticated": "UNAUTHENTICATED",
                          "NotAuthenticated": "UNAUTHENTICATED",
                          "AnonymousAccess": "UNAUTHENTICATED",
                          "Permission": "PERMISSION_DENIED",
                          "Unauthorized": "PERMISSION_DENIED",
                          "NotAuthorized": "PERMISSION_DENIED",
                          ...
                          "RequestLimit": "ABORTED",
                          "Exists": "ALREADY_EXISTS",
                          "Exhausted": "RESOURCE_EXHAUSTED",
                          "Throughput": "RESOURCE_EXHAUSTED",
